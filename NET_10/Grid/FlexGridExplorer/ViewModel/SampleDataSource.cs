...
namespace FlexGridExplorer
{
    public class SampleDataSource
    {
        ...
        public SampleDataSource()
        {
            ...
            _allItems.Add(new SampleItem(AppResources.CustomTypeDescriptor,
                AppResources.CustomTypeDescriptor,
                new System.Lazy<System.Windows.Controls.UserControl>(() => new CustomTypeDescriptor())));
