        ...
        public static List<Data> ImportData()
        {
            ...
            for (int i = 1; i < rows.Length; i++)
            {
                ...
                var data = new Data()
                {
                    ...
                    USD = double.TryParse(columns[1], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].USD,
                    JPY = double.TryParse(columns[2], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].JPY,
                    GBP = double.TryParse(columns[3], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].GBP,
                    RUB = double.TryParse(columns[4], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].RUB,
                    CNY = double.TryParse(columns[5], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].CNY,
                    INR = double.TryParse(columns[6], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].INR,
                    KRW = double.TryParse(columns[7], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].KRW,
                    EUR = double.TryParse(columns[8], System.Globalization.NumberStyles.Any, System.Globalization.CultureInfo.InvariantCulture, out d) ? Math.Round(d, 4) : sourceTable[sourceTable.Count - 1].EUR
                };
