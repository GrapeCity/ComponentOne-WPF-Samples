...
namespace AccordionExplorer.Properties {
    ...
    public class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to The C1Accordion control is a container that can hold a series of expandable and collapsible panes for storing text, images, and controls. The C1Accordion control is an ItemsControl, which means that the control is designed to host a series of objects. The C1Expander class represents the items, or accordion panes, that can be hosted by the C1Accordion control.
        /// </summary>
