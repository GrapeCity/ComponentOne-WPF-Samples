...
namespace Orders
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            // Put the lists of cities and countries to the application resources
            // so they are accessible from any window or user control.
            var objectContext = (NORTHWNDEntities) C1.Data.Entities.EntityClientCache.GetDefault(typeof(NORTHWNDEntities)).DbContext;
            Resources.Add("Cities", objectContext.Cities);
            Resources.Add("Countries", objectContext.Countries);
