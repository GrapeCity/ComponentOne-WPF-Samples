...
namespace Printing
{
	...
	public class PrintInfo 
	{
        ...
        private void AddScheduleReferences()
        {
            ...
            AddExternalAssembly(Assembly.GetAssembly(typeof(System.Windows.Media.Color)).Location);

            AddExternalAssembly(Assembly.GetAssembly(typeof(C1.Schedule.Appointment)).Location);
            AddExternalAssembly(Assembly.GetAssembly(typeof(C1.WPF.Schedule.C1ScheduleStorage)).Location);
            AddExternalAssembly("WindowsBase.dll");
            AddExternalAssembly("netstandard.dll");

            AddExternalAssembly(Assembly.GetAssembly(typeof(INotifyCollectionChanged)).Location);
        }
        /// <summary>
