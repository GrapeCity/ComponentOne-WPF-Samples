...
namespace CustomDialogs
{
	...
	public partial class SelectFromListScene : UserControl
	{
		...
		private void UserControl_Loaded(object sender, RoutedEventArgs e)
		{
            ...
            {
                _parentWindow = (ContentControl)C1.WPF.VTreeHelper.GetParentOfType(this, typeof(Window));
            }
            else
            _parentWindow = (ContentControl)C1.WPF.VTreeHelper.GetParentOfType(this, typeof(C1Window));
        ...
        private void SourceItemSelectedCB_GotFocus(object sender, RoutedEventArgs e)
        {
            ...
            if (item == null || !item.GetType().IsSubclassOf(typeof(C1.Schedule.BasePersistableObject)))
                return;
