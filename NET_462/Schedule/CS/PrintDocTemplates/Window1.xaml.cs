...
namespace PrintDocTemplates
{
	...
	public partial class Window1 : Window
	{
		...
		private void _printDoc_DocumentStarting(object sender, EventArgs e)
		{
            ...
            _printDoc.ScriptingOptions.ExternalAssemblies.Add(Assembly.GetAssembly(typeof(C1.Schedule.Appointment)).Location);
            _printDoc.ScriptingOptions.ExternalAssemblies.Add(Assembly.GetAssembly(typeof(C1.WPF.Schedule.C1ScheduleStorage)).Location);
