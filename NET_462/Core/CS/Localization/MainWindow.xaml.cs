...
namespace Localization
{
    ...
    public partial class MainWindow : Window
    {
        public MainWindow()
        {
            ...
            dataGrid.ItemsSource = Person.Generate(100);
            olap.Loaded += (s, ea) =>
            {
                olap.DataSource = Person.Generate(100);
        ...
        private void C1TabControl_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {
            ...
            //try
            //{
            //    IsolatedStorageSettings.ApplicationSettings["tabIndex"] = tabControl.SelectedIndex;
            //}
            //catch
            //{
