...
namespace FlexGridExplorer
{
    ...
    /// </summary>
    public partial class CustomMerging : UserControl
    {
        public CustomMerging()
        {
            InitializeComponent();
            Tag = AppResources.CustomMergingDescription;
        ...
        {
            grid.Columns.Add(new GridColumn { Header = AppResources.Monday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
            grid.Columns.Add(new GridColumn { Header = AppResources.Tuesday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
            grid.Columns.Add(new GridColumn { Header = AppResources.Wednesday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
            grid.Columns.Add(new GridColumn { Header = AppResources.Thursday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
            grid.Columns.Add(new GridColumn { Header = AppResources.Friday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
            grid.Columns.Add(new GridColumn { Header = AppResources.Saturday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
            grid.Columns.Add(new GridColumn { Header = AppResources.Sunday, Width = new GridLength(1, GridUnitType.Star), MinWidth = 120, AllowMerging = true, HeaderHorizontalAlignment = HorizontalAlignment.Center, HorizontalAlignment = HorizontalAlignment.Center });
