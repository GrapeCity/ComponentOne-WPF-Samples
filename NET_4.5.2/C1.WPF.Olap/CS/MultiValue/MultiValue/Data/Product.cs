...
namespace MultiValue
{
    ...
    public class Product : 
        ...
        IEditableObject
    {
        static string[] _lines = "Computers|Washers|Stoves|Freezers|Heaters|Coolers".Split('|');
        static string[] _colors = "Red|Green|Blue|White|Black".Split('|');
        ...
        public static ObservableCollection<Product> GetProducts(int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                p.Discontinued = rnd.NextDouble() < .5;
