...
namespace StockAnalysis.Utilities
{
    ...
    {
        public static HsbColor RgbToHsb(System.Windows.Media.Color rgbColor)
        {
        ...
        public static System.Windows.Media.Color HsbToRgb(HsbColor hsbColor)
        {
            ...
            if (hsbColor.S == 0.0)
            {
                return System.Windows.Media.Color.FromArgb((byte)(hsbColor.A * 255),
                                                    (byte)(hsbColor.B * 255),
                                                    (byte)(hsbColor.B * 255),
                                                    (byte)(hsbColor.B * 255)
                                                    );
