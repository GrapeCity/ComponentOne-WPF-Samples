...
Namespace CustomDialogs
	...
	Partial Public Class SelectFromListScene
		...
		Private Sub SourceItemSelectedCB_GotFocus(ByVal sender As Object, ByVal e As RoutedEventArgs)
			...
			If item Is Nothing OrElse (Not item.GetType().IsSubclassOf(GetType(C1.C1Schedule.BasePersistableObject))) Then
				Return
			End If
			...
			If Not String.IsNullOrEmpty(str) Then
				...
				If obj Is Nothing Then
					...
					ElseIf ItemType Is GetType(Resource) Then
						...
						res.MenuCaption = str
						obj = res
					ElseIf ItemType Is GetType(C1.C1Schedule.Label) Then
