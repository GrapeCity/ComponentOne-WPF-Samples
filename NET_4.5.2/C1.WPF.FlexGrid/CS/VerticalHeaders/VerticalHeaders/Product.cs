...
namespace VerticalHeaders
{
        ...
        IEditableObject
    {
        ...
        [Display(Name = "AbsoluteVolume")]
        public double AbsoluteVolume
        {
        ...
        public static ICollectionView GetProducts(int count)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                p.GrossPrice = rnd.Next(1, 1000);
                p.GrossWeight = rnd.Next(1, 100);
                p.NetCost = rnd.Next(1, 600);
                p.AbsoluteVolume = rnd.Next(500, 5000);
